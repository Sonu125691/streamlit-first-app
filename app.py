...
if st.session_state.page == "Home":
    ...
    Several models were tested, including Logistic Regression, Support Vector Classifier, Decision Tree, Random Forest, XGBoost, and Gaussian Naive Bayes. 
    The **XGBoost model** performed the best, achieving high accuracy and F1 score, so it has been selected as the final model. 
    The app is designed to be simple and user-friendly: just provide the transaction details, and it will instantly tell you whether it is **Fraudulent** or **Legitimate**.
    """)
